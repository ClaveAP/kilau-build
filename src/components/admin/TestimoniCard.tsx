...
const TestimoniCard: React.FC<TestimoniCardProps> = ({ name, testimoni, rating }) => {
  return (
    <div 
    ...
    >
      ...
      <p className="text-xs text-gray-600 mb-3 flex-grow line-clamp-3 leading-relaxed">{testimoni}</p>
